		...
		<form action="updateinfo.jsp" method="post">
			<div class="form-group">
				<label for="customerId">Customer ID:</label> <input type="text"
					id="customerId" name="customerId" value="<%=rs.getInt(1)%>"required readonly="readonly">
			</div>
			<div class="form-group">
				<label for="customerName">Name:</label> <input type="text"
					id="customerName" name="customerName" value="<%=rs.getString(2)%>" required>
			</div>
			<div class="form-group">
				<label for="customerEmail">Email:</label> <input type="email"
					id="customerEmail" name="customerEmail" value="<%=rs.getString(3)%>" required>
			</div>
			<div class="form-group">
				<label for="customerPassword">Password:</label> <input
					type="password" id="customerPassword" name="customerPassword" value="<%=rs.getString(4)%>"
			...
			<div class="form-group">
				<label for="customerMobile">Mobile No:</label> <input type="tel"
					id="customerMobile" name="customerMobile" value="<%=rs.getLong(5)%>" pattern="[0-9]{10}"
					required>
			</div>
